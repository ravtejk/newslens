...
MIGRATION_0014 = "0014_thread_delta_provenance.sql"   # NL-69: the poisoned-antecedent bound (side table)
...
EXPECTED_TABLES = {
    ...
    "thread_closures", "concept_explanations",
}
